...
//    private String userName;
    ...
    @OneToMany
    private Collection<PatientInDB> patientDatabaseList = new ArrayList<>();
    ...
    public Collection<PatientInDB> getPatientDatabaseList() {
        return patientDatabaseList;
    }

    public void setPatientDatabaseList(List<PatientInDB> patientDatabaseList) {
